...
def calculateTileGridStatistics(tile_grid_shape, tile_size_x: int, tile_size_y: int, form="row_by_row", direction="left_to_right"):
...
if __name__ == '__main__':
    image_path_list = [f"/media/gojira/MERFISH_datasets/download.brainimagelibrary.org/02/26/02265ddb0dae51de/mouse1_sample2_raw/extracted_aligned_images/aligned_images_tiled_{i}_channel0.tiff" for i in range(608)]
    stitched = stitchImageList(image_path_list, (32,19), 2048, 2048)
    plt.imshow(stitched)
    plt.show()
